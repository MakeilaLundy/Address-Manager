...
import com.sap.cloud.sdk.s4hana.datamodel.odata.services.BusinessEventSubscriptionService;
...
public class GetAllBusinessPartnersCommand extends CachingErpCommand<List<BusinessPartner>> {
    ...
    protected List<BusinessPartner> getFallBack(){
    	logger.warn("Fall back called because exception", getExecutionException());
